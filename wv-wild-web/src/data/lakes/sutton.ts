  ...
  campgrounds: [
    {
      ...
      sites: 156,
      siteTypes: ['113 electric (30 amp)', '37 full hookup (water, electric, sewer)', '6 non-electric'],
      amenities: [
      ...
      contact: '(304) 765-7756 or (304) 765-2816',
    },
    {
      ...
      operator: 'U.S. Army Corps of Engineers',
      sites: 77,
      siteTypes: ['8 full hookup', '26 electric', '43 non-electric', '~20 waterfront sites'],
      amenities: [
        'Heated shower houses',
        'Flush toilets',
        'Dump station',
        ...
        'Extended no-wake zone',
      ],
      fees: '$24-$40/night depending on site type',
      season: 'May 1 - September 30',
      reservations: 'Recreation.gov',
      policies: ['14-day limit per 30-day period', 'Pets on leash', 'Blacktop pads'],
      contact: '(304) 765-5631',
    },
    {
      ...
      operator: 'U.S. Army Corps of Engineers',
      sites: 12,
      siteTypes: ['12 primitive pull-through sites (no hookups)'],
      amenities: [
        'Vault toilets',
        'Fire rings',
        'Lantern posts',
      ...
      policies: ['14-day limit per 30-day period', 'Max RV length 35 feet', 'Hilltop location with views'],
