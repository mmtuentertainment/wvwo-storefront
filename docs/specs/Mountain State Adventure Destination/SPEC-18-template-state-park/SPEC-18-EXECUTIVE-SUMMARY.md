...
4. **Schema.org Complexity**: Google Rich Results Test during development + code review
5. **Type Scope Creep**: 6-hour timebox (hard stop) + MVP mindset
6. **Testing Discovery**: Test-driven development + incremental integration
