...
PARK METADATA:
- Exact acreage (verify official WV State Parks data)
- Year established (historical records)
- GPS coordinates (latitude/longitude to 4 decimal places)
- County and tourism region classification
- Elevation range (min/max in feet)
- Signature natural features (Tecumseh Falls height, other waterfalls)

CABIN INVENTORY:
- Total cabin count and breakdown by bedroom configuration (1BR, 2BR, 3BR, 4BR)
- Specific amenities for each cabin tier (kitchen type: full/partial/none, fireplace: yes/no, bathrooms count, max occupancy)
- Seasonal availability (year-round vs seasonal)
- Current rental rates by season (low vs peak)
- ADA-accessible cabin count and specific features
- Pet-friendly cabin availability and fees

CAMPGROUND DETAILS:
- Total campsite count (verify against official data)
- Hookup breakdown: Full (water/electric/sewer), Partial (water/electric), Primitive (none)
- Bathhouse count and locations
- Dump station availability
- Max RV length accepted
- Campground amenities (laundry, camp store, wifi, etc.)
- ADA-accessible site count
- Camping season dates (open/close)
- Nightly camping rates by site type

ADDITIONAL FACILITIES:
- Picnic areas: shelter count, capacity, reservable status
- Swimming pool: indoor/outdoor, seasonal hours, lifeguard schedule
- Playground: age groups, equipment types
- Visitor center: hours, exhibits, gift shop
- Nature center: programming, live exhibits

Provide citations from wvstateparks.com official pages and cross-reference with recent 2025-2026 visitor reviews for accuracy verification.
```
...
Holly River State Park, established in 1938, stands as West Virginia's second-largest state park with 8,101 acres of densely forested mountain terrain in Webster County. This comprehensive facility inventory provides detailed metadata, cabin specifications, campground infrastructure, and recreational amenities based on official West Virginia State Parks sources and cross-referenced with recent 2025-2026 visitor data. The park offers 10 historic cabins (nine CCC-era structures plus one modern accessible unit), 88 electric-hookup campsites, extensive trail networks accessing signature waterfalls, and seasonal recreational facilities in the Mountain Lakes tourism region.[^1][^2][^3]
...
**Official Acreage:** 8,101 acres[^3][^1]
*Note: Minor variations exist in historical documents (8,242 acres in National Register records, 8,294 acres in some sources), but current official WV State Parks documentation consistently cites 8,101 acres.*[^4][^5]

**Year Established:** 1938[^6][^7][^1]
The park officially opened as a West Virginia State Park in 1938 under the West Virginia Conservation Commission. The federal government retained ownership until 1954, when full deed transfer to the state occurred.[^1][^6]

**GPS Coordinates:** 38.6648°N, 80.3345°W[^8]
*Alternative coordinates: 38.66639°N, 80.32694°W (Wikipedia); 38.635700°N, 80.320045°W (Upper Falls specific location)*[^9][^10]

**County:** Webster County, West Virginia[^3][^1]

**Tourism Region Classification:** Mountain Lakes Region[^1]

**Physical Address:**
680 State Park Road
Hacker Valley, WV 26222[^3]

### Topographic Features

**Elevation Range:**

- **Minimum:** 1,600 feet[^11]
- **Maximum:** 3,000 feet[^11]
- **Mountain Peaks:** Surrounding mountains reach elevations exceeding 2,800 feet[^12][^1]
- **Potato Knob Summit:** 2,480 feet (popular overlook destination)[^13][^14]

**Primary Waterway:** Left Fork of Holly River flows through the park core[^10][^1]

### Signature Natural Features \& Waterfalls
...
| **Tenskwatawa Falls** | ~15 feet[^16] | Tenskwatawa Branch | Potato Knob Trail (side trail)[^16] |
| **Upper Falls** | ~20 feet[^9] | Fall Run/Left Fork Holly River | Route 3 access, boardwalk stairs[^9] |
| **Shupe's Chute** | Circular chute formation | Left Fork Holly River | Route 3 access[^17][^18] |
| **Mystic Falls** | Hidden cascade | Tramontane Trail (2.3 mi mark)[^13] | Tramontane Trail[^13] |
| **Lower Falls** | Variable | Left Fork Holly River | Potato Knob Trail area[^11] |

**Shupe's Chute** deserves special mention as one of West Virginia's most unusual waterfall formations—a circular, chute-like channel that funnels the entire flow of the Left Fork of Holly River before cascading into a natural swimming hole, named after park superintendent Walter Shupe (served 1966-1984).[^17][^18]
...
| :-- | :-- | :-- |
| Cabins 1-9 | April through November[^2] | Seasonal |
| Cabin 10 | All year[^2] | Year-round |
...
**Pet-Friendly Cabins:** Cabins 6, 9, and 10[^2]

**Pet Policy \& Fees:**

- **Fee:** \$20 per day[^20]
- **Limit:** Maximum 2 pets per cabin[^20]
- **Weight Restriction:** 15 pounds per pet maximum[^20]
...
**Cabin 10** (Vacation Cabin) is the park's sole ADA-accessible accommodation, featuring:

- Full accessibility compliance[^2]
- Central heat and air conditioning (no firewood management required)[^2]
- Gas log fireplace (vs. wood-burning in Legacy cabins)[^2]
- Modern construction with two bedrooms[^2]

***

## CABIN AMENITIES BY TIER
...
- Stone and log construction[^2]
- Nestled in dense rhododendron and hemlock forest[^2]
- Adjacent to Laurel Fork tributary[^2]

**Kitchen Facilities:**

- **Type:** Fully equipped kitchen[^2]
- **Appliances:** Range, refrigerator/freezer, dinner and cookware[^2]
- **Status:** Full kitchen capability (no partial kitchens)[^2]

**Heating \& Cooling:**

- Mini-split wall-mount HVAC units (heating and air conditioning)[^2]
- Wood-burning stone fireplace[^2]

**Bathroom Configuration:**

- **Count:** 1 bathroom with shower per cabin[^2]
- On-demand hot water[^2]

**Occupancy:**

- Maximum: 2, 4, or 6 people (varies by cabin)[^2]
- Specific bed types and configurations maintained in reservation system[^2]

**Additional Amenities:**

- Linen service (linens provided)[^2]
- Electricity and water[^2]
- Outside grill[^2]
- Wireless Internet (WiFi)[^21][^2]

**Recent Upgrades (noted in 2024 visitor reviews):**
...
The park's year-round, ADA-compliant cabin offers contemporary amenities:[^2]

**Construction:** Frame-built modern structure[^2]

**Bedroom Configuration:**

- **Bedrooms:** 2[^2]
- Specific bed types not detailed in official sources

**Kitchen Facilities:**

- **Type:** Fully equipped kitchen[^2]
- **Appliances:** Range, refrigerator/freezer, microwave, dinner and cookware[^2]

**Heating \& Cooling:**

- Central heat and air conditioning[^2]
- Gas log fireplace (no wood hauling required)[^2]

**Bathroom Configuration:**

- Full bathroom with shower[^2]
- ADA-accessible design[^2]

**Additional Amenities:**

- Linen service provided[^2]
- On-demand hot water[^2]
- Outside grill and fire ring[^2]
- Wireless Internet[^2]
...
**Official Rate Availability:** Specific nightly rates are not published on the WV State Parks website. Rates are displayed in the online reservation system when dates are entered.[^2]

**Current Promotions (as of January 2026):**

- **15% discount** on lodge and cabin stays with promo code **JOLLY**[^22]
- Valid through March 15, 2026[^22]
- 2-night minimum stay required[^22]

**Discount Programs Available:**

- **Senior Discount:** 10% off for ages 60+ with valid ID[^22]
- **Veterans/Military Discount:** Special rates for active duty and veterans[^22]
- **Government Rate:** For state and federal employees on official travel (code: GOV)[^22]

**Comparative Context:**
While Holly River's specific rates are not published, comparable West Virginia State Park cabins average \$99-\$266 per night based on third-party booking data, with economy options starting around \$30-50 per night.[^23][^24]
...
**Total Campsite Count:** 88 sites[^25][^26][^3]

**Hookup Breakdown:**

- **Electric Hookups:** All 88 sites include electric hookups[^26][^27]
- **Water Hookups:** Not available at individual sites[^26]
...
- **Count:** 4 centralized bathhouses[^28][^25][^26]
- **Facilities:** Hot showers included[^29]

**Dump Stations:**

- **Count:** 3 sanitary dump stations[^27][^26]
- **Availability:** Available for all campers[^26]
...
**Maximum RV/Trailer Length:** 32 feet[^30][^28]

**Electrical Service:** Standard electric hookups (amperage specifications not detailed in official sources)

### Campsite Amenities

Each of the 88 campsites includes:[^26]
...
**Site Restrictions:** Only one tent or trailer permitted per site[^26]

### Campground Seasons \& Reservation Policy

**Operating Season:** Spring through fall, weather permitting[^3][^26]

**Reservation Requirements:**

- **Weekend Minimum:** 2 consecutive nights (Friday-Saturday)[^26]
- **Weekday Minimum:** 1 night (Sunday-Thursday)[^26]
- **Maximum Stay:** 14 nights[^26]

**Check-in Time:** 1:00 PM[^26]

**Reservation Methods:**

- Online at WVstateparks.com[^26]
...
**Note:** While accessible sites exist at comparable WV State Parks, Holly River's specific count of ADA-compliant campsites was not detailed in available documentation.
...
| :-- | :-- | :-- | :-- |
| Babcock State Park | Electric hookup | \$45 | [^31] |
| Babcock State Park | Non-electric | \$35 | [^31] |
| Tomlinson Run | Tent sites (non-electric) | ~\$28 | [^32] |
| Stonewall Resort | Premium lake view | \$71-77 | [^33] |

**Estimated Range:** Based on comparable parks, Holly River's electric hookup sites likely range from \$30-50 per night, though official confirmation requires checking the reservation system.
...
| **Balli Pavilion** | Up to 30 people[^34] | Smaller group setting[^34] | Yes, up to 1 year advance[^35] |

**Location:** Picnic facilities situated near trout-rearing pond adjacent to park headquarters[^35]

**Amenities:** Shelters include picnic tables; specific counts of non-reservable picnic tables scattered throughout park not detailed in sources.
...
| :-- | :-- | :-- | :-- |
| Memorial Day - Mid-August | Wednesday-Sunday | 11 AM - 6 PM[^36] | Full weekly schedule |
| Mid-August - Season Close | Weekends only | 11 AM - 6 PM[^36] | Pending lifeguard availability[^36] |
| Holiday Mondays | Open if Monday is holiday[^36] | 11 AM - 6 PM[^36] | Memorial Day, July 4, Labor Day |

**Admission Fees:**

- Adults: \$6[^36]
- Children: \$4[^36]
- Pool passes available for purchase at park headquarters[^36]

**Lifeguard Schedule:** Pool operates only when lifeguards are available; closures possible after mid-August due to staffing.[^36]

**Seasonal Closure:** Pool closes for the season in mid-August during weekdays; weekend operation continues through Labor Day weekend, staffing permitting.[^36]

### Playground

**Count:** At least 1 playground facility[^37][^38]

**Age Groups Served:** Not specified in official sources

**Equipment Types:** Not detailed in available documentation

**Location:** Near main activity area based on park maps[^38][^37]

### Visitor Center \& Park Headquarters

**Park Office Location:** 680 State Park Road, main park complex[^3]

**Hours:** Park grounds open 6 AM - 10 PM daily[^3]

**Office Hours:** Not specified; contact 304-493-6353 for current hours[^3]

**Exhibits:** Park office serves administrative functions; no dedicated visitor center with exhibits noted in official sources.

**Gift Shop:**

- Located at park headquarters[^39][^37]
...
Only seven West Virginia State Parks feature dedicated Nature Centers (Blackwater Falls, Cacapon, Kanawha State Forest, among others), and Holly River is not among them.[^40]

**Alternative Nature Programming:**

**Seasonal Naturalist:**

- Programs offered Memorial Day through Labor Day[^35]
- Activities include guided hikes, nature films, marshmallow roasts[^28]
- Contact park program coordinator for current schedule[^28]

**Self-Guided Interpretive Trail:**

- **Nature's Rock Garden Trail** (0.4 miles)[^13]
- Beginning at cabin area parking lot[^13]
- Interpretive booklets available at information kiosk[^13]

**ADA-Accessible Interpretive Trail:**

- **Laurel Fork Trail** (0.4 miles)[^41][^13]
...
**Holly River Restaurant (The Cookhouse):**[^43][^35]

- Listed among "101 Unique Places to Dine in WV"[^43][^42]
- Home-style meals, sit-down dining area[^35]
- Free Wi-Fi available[^35]
...
| Memorial Day - Labor Day | 7 days/week | 8 AM - 8 PM[^35][^43] |
| Labor Day - Season Close | Friday-Sunday | 8 AM - 8 PM[^43] |

**Winter Closure:** Restaurant closed during winter months; call 304-493-9493 to confirm hours before visiting.[^43]

**On-Site Store:**

- Small convenience store[^10]
- Staple groceries and sundries[^10]
- Seasonal operation[^10]

**Nearby Off-Site Option:**
...
**Total Trail Mileage:** 42+ miles[^13][^3][^10]

**Trail Difficulty Range:** Easy to Difficult (Potato Knob Trail rated difficult with ~600 ft elevation gain)[^16][^21]

**Popular Trails:**

- Potato Knob Trail (7.5 miles one-way to summit)[^13]
- Reverie Trail (3.5 miles, access to Tecumseh Falls)[^13]
- Wilderness Trail (4.5 miles)[^13]
- Ridge Road Trail (6.1 miles, multi-use: hiking, biking, horseback)[^13]

**Multi-Use Trails:**

- Biking: Ridge Road Trail[^13]
- Horseback Riding: Ridge Road Trail, Rock Camp Trail[^10]

**Equestrian Facilities:**

- Corrals available for campers with horses[^42][^1]
- Designated equestrian campsites[^10]

***

## CROSS-VERIFICATION WITH 2025-2026 VISITOR REVIEWS

### Recent Visitor Feedback (Reddit, TripAdvisor, Facebook)

**Positive Themes:**

**Cabin Quality (2024):**[^21]

- "Cabins have been remodeled a few years ago and have on-demand hot water and new HVAC units with AC"
- Recent upgrades confirmed by multiple visitors

**Park Experience (2024-2025):**[^45][^21]

- "It's my favorite park in the state" (multiple reviewers)
- "One of the best" West Virginia state parks
- Praised for waterfalls, trails, peaceful atmosphere

**Campground:**[^14]

- "We've been coming here for years. I'm a 3rd generation and my son is the 4th. The only campground we want to go to."
- Creekside sites highly desirable[^21]

**Waterfall Accessibility (2025):**[^45]

- "Beautiful WV waterfalls along Holly River State Park's Potato Knob Trail"
- Upper Falls, Shupe's Chute, and Potato Knob frequently mentioned in recent reviews[^17][^21]

**Concerns Noted:**

**WiFi Installation (2024):**[^21]

- One long-time visitor expressed concern about WiFi installation near trout streams
- Believes technology detracts from wilderness experience

**Bathhouse Condition:**[^21]

- Described as "a bit run-down" with plans for upgrades mentioned
...
- ✓ Recent cabin renovations (HVAC, hot water systems)
- ✓ 88 campsite count
- ✓ 4 bathhouses
- ✓ Creekside camping availability
- ✓ WiFi installation (now listed on official site)
- ✓ Waterfall locations and trail access

***

## DATA SOURCE SUMMARY

This comprehensive inventory synthesizes data from:

**Primary Official Sources:**

- WV State Parks official website (wvstateparks.com)[^1][^35][^36][^3][^13][^26][^2]
- National Register of Historic Places documentation[^4]
- WV Tourism (wvtourism.com)[^46][^25][^42][^43]
- Official park maps and trail guides[^37][^38][^11]

**Cross-Reference Sources:**

- Mountain State Waterfalls (wvfalls.com)[^15][^9][^16]
- TopoZone elevation and coordinate data[^8]
- Webster County Tourism[^42]

**Verification Sources:**

- TripAdvisor reviews (2024-2026)[^47][^12]
- Reddit r/WestVirginia discussions (2024)[^21]
- Facebook user posts (2025)[^45]
- The Dyrt camping reviews (2023-2024)[^29]

***

## LIMITATIONS \& DATA GAPS

**Information Not Available in Official Sources:**

1. **Pricing:**
    - Cabin nightly rates not published (reservation system only)
    - Camping nightly rates not published (reservation system only)
2. **Cabin Bedroom Configurations:**
    - Specific bed types per cabin (queen, twin, etc.) not detailed
    - Exact bedroom count for Cabins 1-9 not specified individually
3. **ADA Accessibility:**
    - Count of ADA-accessible campsites not specified
    - Playground accessibility features not detailed
4. **Capacity Specifications:**
    - Exact occupancy limits per cabin not stated (only "2, 4, or 6 people" ranges)
    - Pavilion exact capacity numbers beyond "large groups" and "up to 30"

**Note:** These specifications are maintained in the online reservation system and can be viewed when selecting specific dates and units for booking.[^2]
...
**Online Reservations:** WVstateparks.com
...
Holly River State Park's creation represents a significant New Deal conservation success story. Following decades of deforestation by timber operations in the late 1800s, the U.S. Department of Agriculture began land acquisition in 1935-1937. The Works Progress Administration (WPA) employed 250 workers to rehabilitate the land and construct facilities beginning in January 1936.[^5][^4][^1]

The park's nine Legacy cabins, built between 1936-1938, exemplify Civilian Conservation Corps (CCC) and WPA craftsmanship, featuring locally quarried stone and hand-hewn logs. These structures achieved National Register of Historic Places designation as part of the "New Deal Resources in West Virginia State Parks and Forests" multiple property listing.[^19][^4][^2]

Swiss immigrants originally settled the area around 1870, clearing timber for farmland. Today's dense forests represent successful 1930s reforestation efforts that transformed degraded agricultural land into the thriving 8,101-acre wilderness visitors enjoy today.[^14][^1]
