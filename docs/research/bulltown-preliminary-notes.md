# Bulltown Historical Area - Preliminary Research Notes

**Status**: PRELIMINARY - All facts marked [VERIFY] need source confirmation
**Created**: 2025-12-15
**Purpose**: Working knowledge base for Burnsville Lake unique angle

---

## What We Know (To Be Verified)
...
## Geographic Context (From Existing Page)

**From burnsville-lake.astro Line 167**:
...
4. **No family education angle** (history = reason for non-anglers to care)
...
<div>
  ...
  <span class="text-sm text-brand-brown/60">Civil War Site</span>
</div>
```
  ...
  <div class="container mx-auto px-4">
    <div class="max-w-3xl mx-auto">
      ...
      <div class="bg-brand-cream p-6 rounded-sm border-l-4 border-sign-green">
        <h3 class="font-bold text-brand-brown mb-2">Civil War History On-Site</h3>
        <p class="text-brand-brown/75 mb-4">
          [PENDING RESEARCH: 2-3 sentences about Battle of Bulltown, what visitors can see]
        </p>
        <p class="text-sm text-brand-brown/60">
          Good spot to stretch your legs between fishing sessions, especially if
          you've got kids who need more than just sitting in a boat.
        </p>
      </div>
    </div>
  </div>
...
<p class="mt-6 text-sm text-brand-brown/60">
  ...
  Bulltown Historical Area off I-79.
</p>
```
...
<p class="mt-6 text-sm text-brand-brown/60">
  Multiple parking areas and access points throughout the WMA. Main access via
  Bulltown Historical Area off I-79 — a preserved Civil War battlefield with
  [STRUCTURE DETAILS]. [HOURS IF APPLICABLE].
</p>
```
...
- Out-of-state visitors wanting "authentic WV"
...
4. Any good photo opportunities there?
...
- Need real customer stories, not just dates
...
|------|--------|------------|
| Site is poorly maintained/overgrown | HIGH - Can't recommend eyesore | Verify current condition before writing |
| Site is closed/inaccessible | HIGH - Content would be misleading | Check current operating status |
| Site is boring (just a sign, no structures) | MEDIUM - Not worth emphasizing | Get photos/descriptions first |
| Site is far from lake recreation | MEDIUM - Weakens "while you're here" pitch | Verify actual distance/travel time |
...
4. Draft Kim's voice description
5. Identify SEO keywords
...
5. Add schema markup for historical site (if appropriate)
...
- [ ] Page has unique content competitors can't replicate
- [ ] Kim's voice remains authentic (not tourism-brochure-speak)

---

**Status**: PRELIMINARY NOTES COMPLETE
**Blocker**: WebSearch/WebFetch unavailable - needs manual research
**Next Action**: User completes research using template, or enables web tools
**Target**: Verified facts ready for Burnsville Lake page enhancement
