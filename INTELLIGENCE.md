...
| Field | Value | Source |
|-------|-------|--------|
| **Legal Name** | WV Wild Outdoors LLC | Perplexity research |
| **Their Description** | "Sporting goods/country store" | Kim via Messenger (Dec 3, 2024) |
| **Address** | 121 Birch River Rd, Birch River, WV 26610 | Perplexity research |
| **Phone** | (304) 649-2607 | Perplexity research |
| **Email** | bkutt1@yahoo.com | Perplexity research |
| **Owners** | Kindra (Kim) & Bryan Utt | Personal knowledge |
...
## Licenses & Credentials (CONFIRMED)

| Credential | Status | Source |
|------------|--------|--------|
| Type 02 FFL (Pawnbroker) | Active | Perplexity research |
| Vortex Optics Authorized Dealer | Active | Perplexity research |
| WVDNR Hunting & Fishing License Agent | Active | Perplexity research |

---

## Inventory (Observed Nov 30, 2024)

**Matthew's firsthand observation during 2-hour visit:**

- Firearms (locked cases + wall-mounted rifles)
- Fishing gear (tackles to tree stands)
- Hunting accessories (hodgepodge variety, small to large)
- Snacks (jerky, bison summer sausages)
- **No garden items on shelves** (seasonal spring only)

**Confirmed from Facebook/Research:**

- Danner boots (400g - 1200g insulation)
- LaCrosse boots (400g - 1200g insulation)
- Vortex Optics (scopes, binoculars)
- Ammo: .22 TCM, .223 WSSM, .25-06, .30-06, .243, .270, .300 Win Mag
- Deer feed
- Seed potatoes (spring only): Kennebec, Red Pontiac
...
- Kim handles admin/flyers/grants
- Bryan does parks cleaning + side construction/roofing
- Faith-centered ("If in the Lord's will" is constant)
- Financially stretched but debt-free on store
...
## PSYOP Score on Sources

**Score: 32/100** (Low manipulation indicators)

Key findings:
- Perplexity sources passed verification
